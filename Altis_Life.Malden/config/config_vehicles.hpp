    ...
    */
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
            ...
            { "White", "cop", {
                "textures\police\Norwegian_offroad.jpg"
            }, "" },
            { "Taxi", "civ", {
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "White", "cop", {
                "textures\police\Norwegian_hbs.paa"
            }, "" },
            { "Police", "cop", {
                "#(ai,64,64,1)Fresnel(1.3,7)"
            }, "" }
    ...
    class B_Quadbike_01_F {
        ...
        textures[] = {
            ...
            { "White", "cop", {
                "textures\police\Norwegian_quad.paa"
            }, "" },
            { "Rebel Camo", "reb", {
                "\a3\soft_f_gamma\Quadbike_01\data\quadbike_01_indp_hunter_co.paa"
            }, "" }
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
            ...
            { "Police White", "cop", {
                "textures\police\Norwegian_suv.paa"
            }, "" },
            { "Police Black", "cop", {
                "textures\police\Norwegian_suv_black.paa"
            }, "" }
        };
    };
