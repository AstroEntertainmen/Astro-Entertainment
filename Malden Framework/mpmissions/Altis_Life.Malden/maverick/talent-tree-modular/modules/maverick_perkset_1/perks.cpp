...
class perk_locksmith_4 {
    ...
    description = "Learn to pick locks more efficiently and reduce lockpicking times on vehicles<br/><br/><t color='#10FF45'>+35% faster lockpicking</t>";
...
class perk_repair_1 {
    ...
    description = "Learn to repair vehicles more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+10% faster repairing</t>";
...
class perk_repair_2 {
    displayName = "Vehicle Repair 2";
    requiredPerkPoints = 3;
    requiredLevel = 8;
    requiredPerk = "perk_repair_1";
    subtitle = "Level 8 Required, 3 Perk Points";
    description = "Learn to repair vehicles more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+25% faster repairing</t>";
...
class perk_repair_3 {
    displayName = "Vehicle Repair 3";
    requiredPerkPoints = 3;
    requiredLevel = 15;
    requiredPerk = "perk_repair_2";
    subtitle = "Level 15 Required, 3 Perk Points";
    description = "Learn to repair vehicles more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+50% faster repairing</t>";
...
class perk_repair_4 {
    displayName = "Vehicle Repair 4";
    requiredPerkPoints = 3;
    requiredLevel = 18;
    requiredPerk = "perk_repair_3";
    subtitle = "Level 18 Required, 3 Perk Points";
    description = "Learn to repair vehicles more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+75% faster repairing</t>";
    initScript = "maverick\talent-tree-modular\modules\maverick_perkset_1\functions\functions_repairSpeed_4.sqf";
    limitToSides[] = {};
    color[] = {1,1,1,1};
};

class perk_repair_5 {
    displayName = "Vehicle Repair 5";
    requiredPerkPoints = 3;
    requiredLevel = 25;
    requiredPerk = "perk_repair_4";
    subtitle = "Level 25 Required, 3 Perk Points";
    description = "Learn to repair vehicles more efficiently and reduce repairing times on vehicles<br/><br/><t color='#10FF45'>+100% faster repairing</t>";
    initScript = "maverick\talent-tree-modular\modules\maverick_perkset_1\functions\functions_repairSpeed_5.sqf";
    limitToSides[] = {};
    color[] = {1,1,1,1};
};
